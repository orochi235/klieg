...
export const CATALOG: CatalogFont[] = [
  ...
  { id: 'limelight', name: 'Limelight', class: 'display', google: 'Limelight', seeded: true },
  ...
  { id: 'pirata-one', name: 'Pirata One', class: 'display', google: 'Pirata One', seeded: true },
  ...
  { id: 'satisfy', name: 'Satisfy', class: 'script', google: 'Satisfy', seeded: true },
  { id: 'permanent-marker', name: 'Permanent Marker', class: 'script', google: 'Permanent Marker' },
  { id: 'great-vibes', name: 'Great Vibes', class: 'script', google: 'Great Vibes', seeded: true },
